...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./TERYKS.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("xnxx", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S TERYKS -X kill
screen -S TERYKS ./TERYKS
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/tarks12/Files_TERYKS/master/File_Bot/commands.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/tarks12/Files_TERYKS/master/File_Bot/games.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/tarks12/Files_TERYKS/master/File_Bot/Reply.lua") 
...
if tonumber(user_id) == tonumber(126) then  
var = true  
...
if tonumber(user_id) == tonumber(47) then  
var = 'مطور السورس??‍🔧'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور اساسي'  
...
local TERYKS_Msg = ''  
if msgs < 100 then 
TERYKS_Msg = 'لا يوجد تفاعل' 
elseif msgs < 200 then 
TERYKS_Msg = 'استمر بتفاعل' 
elseif msgs < 400 then 
TERYKS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
TERYKS_Msg = 'احسنت بتفاعل' 
elseif msgs < 1200 then 
TERYKS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
TERYKS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
TERYKS_Msg = 'احسن تفاعل'  
elseif msgs < 4000 then 
TERYKS_Msg = 'متفاعل شرار' 
elseif msgs < 4500 then 
TERYKS_Msg = 'احلا تفاعل' 
elseif msgs < 5500 then 
TERYKS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TERYKS_Msg = 'ملوك تفاعل' 
elseif msgs < 9500 then 
TERYKS_Msg = 'ملك تلي' 
elseif msgs < 10000000000 then 
TERYKS_Msg = 'رب التفاعل'  
end 
return TERYKS_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceTERYKS(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,TERYKS_Msg) 
return false  
end 
if text then    
...
local users = TERYKS:scard(TERYKS.."bot:userss")
TERYKS(tostring((TERYKS:get(TERYKS.."bot:leader:gr") or bot_owner)), 0, "🩸✥ هذا دز ستارت للبوت \n🥁✥ معرفه ⌯» @"..(result.username_ or "لا يوجد").."\n🚿✥ ايديه ⌯» { "..msg.sender_user_id_.." }\n🧼✥ اصبح عدد المشتركين { "..users.." }" , 'html') 
end 
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local TERYKS1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..TERYKS1.server.uptime_in_days..'('..TERYKS1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..TERYKS1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..TERYKS1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..TERYKS1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf TERYKS.lua')
os.execute('wget https://raw.githubusercontent.com/tarks12/TERYKS/master/TERYKS.lua')
send(msg.chat_id_, msg.id_,'🔭┇ تم تحديث البوت \n📮┇ لديك اخر اصدار سورس تيركس\n📡┇ الاصدار ← { 1.2v}')
dofile('TERYKS.lua')  
end
if text == 'الاصدار 📟' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'📡┇ اصدار سورس تيركس \n📟┇ الاصدار ←{ 1.2v}') 
end
...
usertext = '\n👤┇ المستخدم » ['..result.title_..'](t.me/'..(username or 'Cl222')..')'
status  = '\n🔘┇ تم رفع مطور في البوت'
...
usertext = '\n👤┇ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'Cl222')..')'
status  = '\n🔘┇ تم رفع مطور في البوت'
...
local TERYKS1_Msg = database:get(bot_id.."TERYKS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TERYKS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ المستخدم ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Cl222')..') \n 📬┇'..TERYKS1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_,'📮┇ البوت ليس ادمن في القناة يرجى رفع ادمن ثم اعادة المحاوله ') 
end
return false  
end
end,nil)
...
t = '\n•يهلا ؏ــمّــࢪُيہ‌‏  نورت كروبـنا سولفف واتونس بـدونن مشـاكلل 💗 ، \n•  name \n• user' 
end 
...
--------------------------------------------------------------------------------------------------------------
if TERYKS_Msg and not Special(msg) then  
local TERYKS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TERYKS_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇المستخدم : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..TERYKS_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇المستخدم : {["..data.first_name_.."](T.ME/Cl222)}\n🚫┇["..TERYKS_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/Cl222)}\n📮┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n👤┇ المستخدم ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n📝┇  تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 ...
 ↬ . [DEVELOPER](t.me/vv_vvg)      

 ↬ . [Information](t.me/mSaab)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ المستخدم ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Cl222')..') \n🔘┇ تـم قفـل التاك بالكتم\n🚸┇ الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/tarks12/Files_TERYKS/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁┇ اهلا بك في متجر ملفات تيركس\n🔰┇ ملفات السورس ↓\n━━━━━━━━━━━━━ ┉\n\n"
local TextE = "\n━━━━━━━━━━━━━ ┉\n🔘┇  علامة تعني { ✓ } ملف مفعل\n🔘┇ علامة تعني { ✘ } ملف معطل\n👤┇ قناة سورس تيركس ↓\n".."📮┇ [اضغط هنا لدخول](t.me/Cl222) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/tarks12/Files_TERYKS/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('TERYKS.lua')  
else
send(msg.chat_id_, msg.id_,"📛┇ عذرا هاذا ملف ليس من ملفات سورس تيركس\n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = Constructor},function(arg,b) 
if b.first_name_ == false then
send(msg.chat_id_, msg.id_,"📬┇حساب المنشئ محذوف")
return false  
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┇ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'Cl222')..')'
status  = '\n📮┇ الايدي » `'..result.sender_user_id_..'`\n⚡┇ تم تنزيل المستخدم مطي في المجموعه\nتعال حبي رجع العربانه لمدير'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤┇ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'Cl222')..')'
status  = '\n📮┇ الايدي » `'..result.sender_user_id_..'`\n🔘┇ تم تنزيل ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
if text == "تفعيل القوانين" or text == 'تفعيل قوانين' then
if Mod(msg) then  
database:set(bot_id.."Rules_Group:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"🚸┇ تم تفعيل القوانين") 
return false  
end
end
if text == "تعطيل القوانين" or text == 'تعطيل قوانين' then
if Mod(msg) then  
database:del(bot_id.."Rules_Group:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"⚠️┇ تم تعطيل القوانين") 
return false end
end
...
if text == "مسح البلاغات" or text == 'حذف البلاغات' then
if BasicConstructor(msg) then  
database:del(bot_id.."my_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"🔖┇ تم ازالة جميع البلاغات في المجموعه..") 
return false end
end
if text == "الرابط" then 
...
database:set(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TERYKS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TERYKS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"👤┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TERYKS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TERYKS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TERYKS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"👤┇ارسل الكلمه الان")  
database:set(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TERYKS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TERYKS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TERYKS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TERYKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TERYKS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TERYKS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n🚸┇قائمة المنع \n━━━━━━━━━━━━━ ┉ \n"
for k,v in pairs(list) do  
local TERYKS_Msg = database:get(bot_id.."TERYKS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TERYKS_Msg.."}\n"    
end  
if #list == 0 then  
...
local status_Link = database:get(bot_id.."Rules_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"📛┇ القوانين معطله ارسل تفعيل القوانين") 
return false  
end
...
send(msg.chat_id_, msg.id_,"🔰┇هلاو عمـࢪي قوانين ﺎلقࢪوب كلا\n✖️┇ممـنوع نشࢪ ﺎلروابـط \n📛┇ممـنوع ﺎلتكلم او نشࢪ صـوࢪ ﺎباحيه \n♻️┇ممـنوع  ﺎعاده توجـيه\n®️┇ممـنوع ﺎلتكلم بلطائفيةة\n⚜️┇ﺎلـࢪجاء ﺎحتࢪام ﺎلمدراء والادمنيه")   
end    
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ المستخدم » ['..result.title_..'](t.me/'..(text1[3] or 'Cl222')..')'..'\n🔘┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
elseif text and (text == "تنظيف جميع الميديا" or text == "تنظيف الميديا") and Manager(msg) then   
    lk_sajad = {[0]=msg.id_}
    ...
    tdcli_function({ID = "GetMessages",chat_id_ = msg.chat_id_,message_ids_ = lk_sajad},function(arg,data)
        new = 0
        lk_sajad2 = {}
        for i=0 ,data.total_count_ do
            if data.messages_[i] and data.messages_[i].content_ and data.messages_[i].content_.ID ~= "MessageText" then
                lk_sajad2[new] = data.messages_[i].id_
                new = new + 1
            end
        end
        Delete_Message(msg.chat_id_,lk_sajad2)
    end,nil)  
    send(msg.chat_id_, msg.id_,"📌┇ تم ازالة من وسائط \n✔️") 
elseif text and (text == "تنظيف جميع الرسائل المعدله" or text == "تنظيف الرسائل المعدلة" or text == "تنظيف الرسائل المعدله") and Manager(msg) then   
    lk_sajad = {[0]=msg.id_}
    local Message = msg.id_
    for i=1,100 do
    Message = Message - 1048576
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيركس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تيركس')
local TERYKS_Msg = {
'تفضل شتريد ؟',
'دا اشرب ماي عيوني',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..TERYKS_Msg[math.random(#TERYKS_Msg)]..']') 
return false
end
...
send(msg.chat_id_, msg.id_,"\n👤┇ تم تنزيل المستخدم من الرتب التاليه \n💠┇ { "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n📛┇ ليس لديه رتب حتى استطيع تنزيل \n")
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيركس').." غادر" or text == 'غادر' then  
...
database:set(bot_id.."TERYKS:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Mod(msg) then
send(msg.chat_id_, msg.id_,'🔖┇ تم تفعيل الزخرفه')
database:set(bot_id.."TERYKS:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."TERYKS:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔖┇اضغط على الاسم ليتم نسخه')
end

if text == "تعطيل الابراج" and Mod(msg) then
send(msg.chat_id_, msg.id_, '📌┇تم تعطيل الابراج')
database:set(bot_id.."TERYKS:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Mod(msg) then
send(msg.chat_id_, msg.id_,'🔖┇ تم تفعيل الابراج')
database:set(bot_id.."TERYKS:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."TERYKS:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TERYKS:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Mod(msg) then
send(msg.chat_id_, msg.id_,'🎗️┇ تم تفعيل حساب العمر')
database:set(bot_id.."TERYKS:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."TERYKS:age_Bots"..msg.chat_id_) == "open" then
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '👤┇ المستخدم الذي قام باضافتك هو » '..Name
...
database:del(bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
end
...
send(msg.chat_id_, msg.id_, "*"..msg.chat_id_.."*", 'md')
end
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..TERYKSk..''..TERYKS..'\n*🔘┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
-- vardump(data) 
TERYKSdx(msg.chat_id_, msg.id_, '📤┇ ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸┇ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┇ عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆┇ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'تعطيل الانستكرام' and Manager(msg) then 
send(msg.chat_id_, msg.id_,'\n🔖┇تم تعطيل الانستا في المجموعه ...')  
database:set(bot_id.."dl_insta"..msg.chat_id_,"close") 
end 
if text == 'تفعيل الانستكرام' and Manager(msg) then 
send(msg.chat_id_, msg.id_,'\n🏷️┇تم تفعيل الانستا في المجموعه ...')  
database:set(bot_id.."dl_insta"..msg.chat_id_,"open") 
end

if text and text:match('^منشور (.*)$') and database:get(bot_id.."dl_insta"..msg.chat_id_) == "open" then      
local Ttext = text:match('^منشور (.*)$') 
send(msg.chat_id_, msg.id_, "♻┇جاري التحميل ...")
sendsaied = {} 
sendsaied.key = "QiJaPmmA"
sendsaied.f = io.popen("echo $(cd $(dirname $0); pwd)"):read('*all')
sendsaied.url = Ttext
local url,res = http.request('http://ay-men.herokuapp.com/Instagram/index.php?all='..JSON.encode(sendsaied))
if url == 'Bad Instagram Url' then
send(msg.chat_id_, msg.id_, "⛔┇هذا ليس منشور انستا ...")
return false
end
local v = JSON.decode(url)
local namefile = download_to_file(v.info.video,msg.id_..'.mp4')
if namefile == 'false' then
send(msg.chat_id_, msg.id_, "🚸┇المنشور لا يمكنك تحميله ...")
os.execute('rm -rf '..msg.id_..'.mp4') 
return false
end
print('download Mp4 done ...\nUrl : '..Ttext..'\nLink : '..v.info.video)
sendVideo(msg.chat_id_,msg.id_, 1, 0 , nil,'./'..msg.id_..'.mp4', nil, nil, nil,'☑️┇تم تحميل المنشور بنجاح ...\n- Ch : @Cl222')
os.execute('rm -rf '..msg.id_..'.mp4') 
end

if text and text:match('^ستوري ([%a%d._]+)$') and database:get(bot_id.."dl_insta"..msg.chat_id_) == "open" then      
local Ttext = text:match('^ستوري ([%a%d._]+)$') 
send(msg.chat_id_, msg.id_, "♻┇جاري التحميل ...")
sendsaied = {} 
sendsaied.key = "QiJaPmmA"
sendsaied.f = io.popen("echo $(cd $(dirname $0); pwd)"):read('*all')
sendsaied.user = Ttext
local url,res = http.request('http://ay-men.herokuapp.com/Instagram/story.php?all='..JSON.encode(sendsaied))
if url == 'null' then
send(msg.chat_id_, msg.id_, "⛔┇هذا الحساب لايضع ستوري ...")
return false
end
local v = JSON.decode(url)
for k,vv in pairs(v) do
if vv.type == 'image/jpeg' then
local namefile = download_to_file(vv.url,k..'.jpg')
print('Download Photo '..namefile)
if namefile == 'false' then
send(msg.chat_id_, msg.id_, "⚠️┇الستوري رقم "..k.." لا يمكنك تنزيلها ...")
os.execute('rm -rf '..k..'.jpg') 
end
print('Download Photo done ...\nUrl : '..vv.url..'\nType : '..vv.type..'\nNumber : '..k)
sendPhoto(msg.chat_id_,msg.id_, 0, 1, nil,'./'..k..'.jpg','📛┇تم تحميل الستوري رقم '..k..' بنجاح ...\n- Ch : @Cl222')
os.execute('rm -rf '..k..'.jpg') 
end
if vv.type == 'video/mp4' then
local namefile = download_to_file(vv.url,k..'.mp4')
print('Download Video '..namefile)
if namefile == 'false' then
send(msg.chat_id_, msg.id_, "🚫┇الستوري رقم "..k.." لا يمكنك تنزيلها ...")
os.execute('rm -rf '..k..'.mp4') 
end
print('Download Video done ...\nUrl : '..vv.url..'\nType : '..vv.type..'\nNumber : '..k)
sendVideo(msg.chat_id_,msg.id_, 1, 0 , nil,'./'..k..'.mp4', nil, nil, nil,'💢┇تم تحميل الستوري رقم '..k..' بنجاح ...\n- Ch : @Cl222')
os.execute('rm -rf '..k..'.mp4') 
end
end
end
...
if text and text:match("^تغير رد المستخدم (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد المستخدم (.*)$") 
database:set(bot_id.."Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"👤┇ تم تغير رد المستخدم الى » "..Teext)
end
...
local text = 'اضغط لمشاهده المستخدم 🚸'
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تيركس')
...
TERYKS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TERYKS)
...
--------------------------------------------------------------------------------------------------------------
SourceTERYKS(data.message_,data)
...
send(msg.chat_id_,0,''..t..'\n━━━━━━━━━━━━━ٴ\n📛┇ تم التعديل على الميديا\n📌┇ المستخدم الي قام بالتعديل\n📮┇ ايدي المستخدم ← `'..result.sender_user_id_..'`\n🚸┇ معرف المستخدم←{ '..users..' }') 
end,nil)
...
------------------------------------------------------------------------
local TERYKSAbot = database:get(bot_id.."TERYKS1:Add:Filter:Rp2"..text..result.chat_id_)   
if TERYKSAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇المستخدم : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..TERYKSAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TERYKS1_Msg = database:get(bot_id.."TERYKS1:Add:Filter:Rp2"..text..result.chat_id_)   
if TERYKS1_Msg then    
send(msg.chat_id_, msg.id_,"👤┇"..TERYKS1_Msg)
